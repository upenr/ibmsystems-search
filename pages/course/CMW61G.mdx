...
# Agenda
<ul><li>Introduction to Shared Queues</li><li>IMS CQS and Shared Queues Mainline Processing</li><li>Enabling Shared Queues</li><li>Special Considerations</li></ul>
