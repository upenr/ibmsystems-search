...
modality: 'CR,ILO'
summary: 'Install, customize, and administer the AIX operating system in a multiuser IBM Power server partitioned environment. The course runs AIX 7.3.'
...
# Short Summary
Install, customize, and administer the AIX operating system in a multiuser IBM Power server partitioned environment. The course runs AIX 7.3.
...
# Keywords
AN14G;AN14;Introduction to AIX and IBM Power systems; UNIX, Kornshell
