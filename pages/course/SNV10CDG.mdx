...
The exercise component implements Transparent Cloud Tiering using an IBM Spectrum Virtualize system to a OpenStack cloud server, creates a cloud snapshot of a volume, and recovers the volume snapshot from the cloud.  
  
Note: This simulation provides guided steps and hints on completing the exercise.
