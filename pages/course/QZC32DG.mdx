---
title: 'QZC32DG: Linux System Administration with IBM Power'
modality: 'SPVC'
summary: 'This course provides the student with the skills to manage a Linux environment based installed on IBM Power.'
