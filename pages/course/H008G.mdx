...
# Agenda
<ul /><li />Welcome and course introduction<li />Unit 1: Spectrum Scale multi-cluster support<li />Exercise 1: Configuring multi-cluster file system access<li />Unit 2: Active File Management (AFM)<li />Exercise 2: Configuring Active File Management (AFM)<li />Unit 3: AFM-based Asynchronous Disaster Recovery (AFM DR)
