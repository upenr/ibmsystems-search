...
# Keywords
CourseintroductionandDFSMSoverview;SS84G;SS84;z/OS

# Prerequisites
<p>You should take the following courses <strong>or</strong> equivalent knowledge may be substituted for these courses.</p><ul><li><i>Introduction to Storage (SS01G)</i></li></ul><p>It is recommended that the student have programming experience which will aid in the writing of the ACS routines.</p>
