...
title: 'ES10G: Fundamental System Skills in zOS'
modality: 'CR'
summary: 'This course is designed to teach you the fundamental practical skills to navigate and work in a zOS environment. It is for IT personnel with a theoretical background of zOS, for example, as taught in An Introduction to the zOS Environment ES05G, and some general practical IT experience.'
...
# Audience
This is for IT personnel with a theoretical background of z/OS (for example, as taught in An Introduction to the z/OS Environment (ES05G)) and some general practical IT experience.
