---
title: 'AS24DG: System Operator for IBM i'
modality: 'SPVC'
summary: 'This extensive course teaches a system operator how to work with and manage IBM i. AS27G and OL19G are follow on courses.'
image: '/static/images/power.jpg'
brand: 'Power Systems - IBM i'
lastPublishedOn: '2023-10-16'
firstCreatedOn: '2002-09-08'
---
# Table of Contents
...
# Short Summary
This course teaches a system operator how to work with and manage IBM i. AS27G and OL19G are follow on courses.

# Duration in Hours ⌚
32

# Content Description
This introductory course enables a new system operator to develop basic to intermediate level skills needed for day-to-day operations of the IBM i. Focus is given to using the GUI (IBM i Access Client Solutions and IBM Navigator for i) as well as 5250 emulation sessions to perform tasks including job control, monitoring, sending messages, managing systems devices, and more. Hands-on exercises reinforce the lecture topics and prepare the student to successfully operate IBM i.
...
# Audience
This course is intended for the person who has responsibility for daily system operations. It is not intended for technical audiences who are seeking an in-depth look at how the IBM i works. This audience should instead attend the *IBM i Technical Introduction (OL4AG)*.
