...
Finally, to pull together all the ideas from the previous units, a few useful tools are introduced which help users customize their environments and write very simple shell scripts.
...
* Basic information technology (IT) conceptsand the role of an operating system
