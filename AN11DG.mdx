...
# Agenda
Unit 1: Introduction to PowerVM logical partitioning  Unit 2: Using the HMC to manage servers and partitions  Unit 3: Basic LPAR operations Unit 4: Power processor and memory virtualization  Unit 5: Power I/O resources  Unit 6: Logical partition management  Demo: Logical partition management 
